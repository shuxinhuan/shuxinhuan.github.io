    ...
    <div id="about">
      ...
      <div className="content">
        ...
        <p>
          ...
          I focus on designing <span className="hl">expressive visualization techniques</span> and <span className="hl">human-AI interfaces</span> that facilitate a broad spectrum of data activities, including data transformation, analysis, decision-making, and storytelling, with a strong emphasis on promoting data literacy and creativity for all.
        </p>
